...
export const getMyTunjangan = async (req, res) => {
    try {
        ...
        const keterlambatan = absenMasuk.map((item, index) => {
            ...
            // jika keterlambatan lebih dari 2 jam, maka potongan 0.75% 
            // jika lebih dari 2 jam, maka potongan akan ditambah 0.75 perdua jam
            const potongan = jamKeterlambatan > 2 ? 0.75 + (jamKeterlambatan - 2) * 0.75 : 0.75
